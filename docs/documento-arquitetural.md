...
Como "ir além" opcional do enunciado, o modelo também foi implementado em Docker, com um replica set MongoDB de 3 nós populado com dados de exemplo. Detalhes em [`implementacao-docker-mongodb.md`](implementacao-docker-mongodb.md) e evidências (prints de `rs.status()`, teste de failover, contagem de documentos por coleção) em [`EVIDENCIAS.md`](EVIDENCIAS.md).
